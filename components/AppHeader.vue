<template>
    ...
    <!-- <aside class="hidden lg:flex fixed left-0 top-0 h-full w-16 items-center justify-center z-40">
        <div class="flex flex-col space-y-8 text-gray-400">
            <div class="h-20 w-[1px] bg-gray-600 mx-auto"></div>
            <a href="https://github.com/BeatrizBastosBorges" target="_blank" class="hover:text-white transition-colors">
                <svg 
            ...
            <a href="https://linkedin.com/in/teu-usuario" target="_blank" class="hover:text-white transition-colors">
                <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    width="24" 
                    height="24" 
