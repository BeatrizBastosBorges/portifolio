<template>
    <footer class="py-8 border-t border-withe bg-[#121212] container mx-auto">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="flex space-x-4 text-[#ABB2BF]">
                        ...
                        <a href="https://linkedin.com/in/beatrizbastosborges" target="_blank" class="hover:text-[#858BF2] transition-colors">
                            <svg 
                                xmlns="http://www.w3.org/2000/svg" 
                                width="24" 
                                height="24" 
