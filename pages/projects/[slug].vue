      ...
      <article>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="prose prose-invert max-w-none text-justify">
            <h2 class="text-white text-xl md:text-2xl font-bold mb-4"><span class="text-[#3DD9BC]">#</span> sobre o projeto</h2>
            <p>{{ doc.about }}</p>

            <h3 class="text-white text-xl md:text-2xl font-semibold mt-4 mb-2"><span class="text-[#3DD9BC]">#</span> minhas contribuições:</h3>
